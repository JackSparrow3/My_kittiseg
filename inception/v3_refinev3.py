...
from inception_utils import CRP as crp
...
def inception_v3_base(inputs,
    ...
    with tf.variable_scope(scope, 'InceptionV3', [inputs]):
        with slim.arg_scope([slim.conv2d, slim.max_pool2d, slim.avg_pool2d],  # TODO change padding to same
            ...
            # net ,end_points= conv(inputs,end_points,[3,3,3,32],name=end_point)
        ...
        with slim.arg_scope([slim.batch_norm, slim.dropout],
            ...
            with tf.variable_scope('Upsampling'):
                with slim.arg_scope([slim.conv2d_transpose], stride=2, padding='VALID', activation_fn=None,
                    ...
                    with tf.variable_scope(end_point):
                        with tf.variable_scope('Branch_0'):
                            branch_0, end_points = conv(net, end_points, [1, 1, 384, 48],
		                                                name='Conv2d_0a_1x1')
                        with tf.variable_scope('Branch_1'):
                            branch_1, end_points = conv(net, end_points, [1, 1, 384, 32],
		                                                name='Conv2d_0a_1x1')
                            branch_1 = slim.conv2d(branch_1, depth(48), [5, 5],
		                                           scope='Conv_1_0b_5x5')
                        with tf.variable_scope('Branch_2'):
                            branch_2, end_points = conv(net, end_points, [1, 1, 384, 32],
		                                                name='Conv2d_0a_1x1')
                        ...
                        with tf.variable_scope('Branch_3'):
                            branch_3 = slim.avg_pool2d(net, [3, 3], 1, 'SAME', scope='AvgPool_0a_3x3')
                            branch_3, end_points = conv(branch_3, end_points, [1, 1, 384, 48],
		                                                name='Conv2d_0b_1x1')
                        net = tf.concat(axis=3, values=[branch_0, branch_1, branch_2, branch_3])
                    end_points[end_point] = net
                    # 92x308x192
                    ...
                    with tf.variable_scope(end_point):
                        with tf.variable_scope('Branch_0'):
                            branch_0, end_points = conv(net, end_points, [1, 1, 128, 8],
		                                                name='Conv2d_0a_1x1')
                        with tf.variable_scope('Branch_1'):
                            branch_1, end_points = conv(net, end_points, [1, 1, 128, 4],
		                                                name='Conv2d_0a_1x1')
                            branch_1 = slim.conv2d(branch_1, 8, [5, 5],
		                                           scope='Conv_1_0b_5x5')
                        with tf.variable_scope('Branch_2'):
                            branch_2, end_points = conv(net, end_points, [1, 1, 128, 4],
		                                                name='Conv2d_0a_1x1')
                            branch_2 = slim.conv2d(branch_2, 8, [3, 3],
		                                           scope='Conv2d_0b_3x3')
                            branch_2 = slim.conv2d(branch_2, 8, [3, 3],
		                                           scope='Conv2d_0c_3x3')
                        with tf.variable_scope('Branch_3'):
                            branch_3 = slim.avg_pool2d(net, [3, 3], 1, 'SAME', scope='AvgPool_0a_3x3')
                            branch_3, end_points = conv(branch_3, end_points, [1, 1, 128, 8],
		                                                name='Conv2d_0b_1x1')
                        net = tf.concat(axis=3, values=[branch_0, branch_1, branch_2, branch_3])
                    end_points[end_point] = net

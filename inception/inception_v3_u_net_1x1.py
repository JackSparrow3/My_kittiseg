            ...
            with tf.variable_scope(end_point):
                with tf.variable_scope('Branch_0'):
                    branch_0 = slim.conv2d(net, depth(384), [3, 3], stride=2,
                                           padding='VALID', scope='Conv2d_1a_1x1')  # TODO change padding to SAME
                with tf.variable_scope('Branch_1'):
            ...
            with tf.variable_scope(end_point):
                with tf.variable_scope('Branch_0'):
                    ...
                    branch_0 = slim.conv2d(branch_0, depth(320), [3, 3], stride=2,
                                           padding='VALID', scope='Conv2d_1a_3x3')  # TODO change padding to SAME
                with tf.variable_scope('Branch_1'):
                    branch_1 = slim.conv2d(net, depth(192), [1, 1], scope='Conv2d_0a_1x1')
                    branch_1 = slim.conv2d(branch_1, depth(192), [1, 7],
                                           scope='Conv2d_0b_1x7')
                    ...
                    branch_1 = slim.conv2d(branch_1, depth(192), [3, 3], stride=2,
                                           padding='VALID', scope='Conv2d_1a_3x3')  # TODO change padding to SAME
                with tf.variable_scope('Branch_2'):
                    branch_2 = slim.max_pool2d(net, [3, 3], stride=2, padding='VALID',  # TODO change padding to SAME
        ...
        with slim.arg_scope([slim.batch_norm, slim.dropout],
            ...
            with tf.variable_scope('Upsampling'):
                with slim.arg_scope([slim.conv2d_transpose], stride=2, padding='VALID', activation_fn=None,
                    ...
                    end_points[end_point]=net
                    # 10x37x1280
                    end_point='score_mixed_7a'
                    net=slim.conv2d(end_points['Mixed_7a'],depth(1280),[1,1],padding='SAME',stride=1,scope='score_mixed_7a')
                    end_points[end_point]=net
                    # 10x37x1280
                    end_point='fuse_0'
                    net=tf.concat([end_points['score_mixed_7a'],end_points['mixe_7c_conv_1']],axis=3,name='fuse_0')
                    end_points[end_point]=net
                    # 10x37x2560
                    ...
                    end_points[end_point] = net
                    # 22x7x768
                    end_point='score_mixed_6e'
                    net = slim.conv2d(end_points['Mixed_6e'],depth(768),[1,1],padding='SAME',stride=1,scope='score_mixed_6e')
                    end_points[end_point]=net
                    #22x7x768
                    end_point = 'fuse_1'
                    net = tf.concat([end_points['Conv2d_Trans_1'],end_points['score_mixed_6e']],axis=3,name='fuse_1')
                    end_points[end_point] = net
                    # 22x7x1536
                    ...
                    end_points[end_point] = net
                    # 45x153x288
                    end_point='score_mixed_5d'
                    net=slim.conv2d(end_points['Mixed_5d'],depth(288),[1, 1],padding='SAME',stride=1,scope='score_mixed_5d')
                    end_points[end_point]=net
                    # 45x153x288
                    end_point='fuse_2'
                    net = tf.concat([end_points['Conv2d_Trans_2'],end_points['score_mixed_5d']],axis=3,name='fuse_2')
                    end_points[end_point]=net
                    # 45x153x576
                    ...
                    end_points[end_point] = net
                    # 92x308x192
                    end_point='score_conv2d_4a_3x3'
                    net=slim.conv2d(end_points['Conv2d_4a_3x3'],depth(192),[1,1],padding='SAME',stride=1,scope='score_conv2d_4a_3x3')
                    end_points[end_point]=net
                    # 92x308x192
                    end_point = 'fuse_3'
                    net = tf.concat([end_points['Conv2d_Trans_3'], end_points['score_conv2d_4a_3x3']], axis=3, name='fuse_3')
                    end_points[end_point] = net
                    # 92x308x384
                    ...
                    end_points[end_point] = net
                    # 189x621x64
                    end_point='score_conv2d_2b_3x3'
                    net = slim.conv2d(end_points['Conv2d_2b_3x3'],depth(64),[1,1],padding='SAME',stride=1,scope='score_conv2d_2b_3x3')
                    end_points[end_point]=net
                    # 189x621x64
                    end_point = 'fuse_4'
                    net = tf.concat([end_points['Conv2d_Trans_4'], end_points['score_conv2d_2b_3x3']], axis=3, name='fuse_4')
                    end_points[end_point] = net
                    # 189x621x128

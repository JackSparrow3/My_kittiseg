  ...
  with tf.variable_scope(scope, 'InceptionV3', [inputs, num_classes],
    ...
    with slim.arg_scope([slim.batch_norm, slim.dropout],
      ...
      with tf.variable_scope('Upsampling'):
        with slim.arg_scope([slim.conv2d_transpose], stride=2, padding='VALID', activation_fn=None, normalizer_fn=None,weights_regularizer=slim.l2_regularizer(5e-4)):    #TODO CHANGE padding to SAME
          # 1 x 1 x 1000

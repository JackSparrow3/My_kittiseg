...
import ResNet.resnet_refine_v1 as resnet
...
image_input=tf.placeholder(tf.float32,[None,384,1248,3])
...
with slim.arg_scope(resnet.resnet_arg_scope()):
    net,end_points = resnet.resnet_v2_50(image_input, 2, True, False)
# print 1
# for i in end_points:
#     print i

...
def main(arg=None):
    ...
    # reader = tf.train.NewCheckpointReader("/home/yu/projects/FCN-GoogLeNet/model/allmodel.ckpt-100000")
    # variables = reader.get_variable_to_shape_map()
    # for ele in variables:
    #     print (ele)
    reader = tf.train.NewCheckpointReader("/home/yu/projects/KittiSeg/RUNS/InceptionV3_dropout=0.8_f1=93.5/model.ckpt-92000")
    variables = reader.get_variable_to_shape_map()
    for ele in variables:
        print(ele)
    # saver=tf.train.import_meta_graph("/home/yu/projects/FCN-GoogLeNet/model/allmodel.ckpt-100000.meta")
    # with tf.Session() as sess:
    #     saver.restore(sess,"/home/yu/projects/FCN-GoogLeNet/model/allmodel.ckpt-100000")
    #     # print (sess.run(tf.get_default_graph().get_tensor_by_name("conv1:0")))
    #
    #
    #     print (sess.run(tf.get_default_graph().get_tensor_by_name("InceptionV3/Conv2d_1a_3x3/weights:0")))

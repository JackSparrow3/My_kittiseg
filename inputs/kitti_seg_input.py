...
#download the data road from kitti and vgg16.npy if they are not downloaded --------------yu
...
#just load the image and gt_image-------------------------------yu
...
# this seems like a pre-process on input image ,and change different color on road and background , and finally it will return the image and gt_image------yu
...
#this function will do some data-enhance if it set to --------------------yu
...
#I don't know what this function want to do ------------------------------------------yu
...
#this function will read the image from the queue, and do some hue or whitening if requested----------yu
